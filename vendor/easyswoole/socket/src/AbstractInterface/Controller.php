...
abstract class Controller
{
    ...
    public function __hook(\Swoole\Server $server,Config $config,Caller $request,Response $response)
    {
        ...
        //设置日志类的caller
        \EasySwoole\EasySwoole\Logger::getInstance()->setCaller($request);
        \EasySwoole\EasySwoole\Logger::getInstance()->info("===== " . "Begin at " . date("Y-m-d H:i:s", time()) . " =====");
        \EasySwoole\EasySwoole\Logger::getInstance()->info("param = " . print_r($request->getArgs(), true));
        try{
        ...
        \EasySwoole\EasySwoole\Logger::getInstance()->info("param = " . print_r($request->getArgs(), true));
        \EasySwoole\EasySwoole\Logger::getInstance()->info("===== " . "End at " . date("Y-m-d H:i:s", time()) . " =====");
    }
}